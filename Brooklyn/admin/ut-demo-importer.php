	...
	function ut_view_updater() { ?>
		...
		<div id="ut-importer" class="wrap">
			...
			*/
            ...
            <div class="xml">
                <input type="radio" id="landing_page" name="ut_demo_file" value="landing_page" class="ut-choose-demo-radio">
                <label class="ut-choose-demo-img" for="landing_page">
                    <img src="<?php echo THEME_WEB_ROOT; ?>/admin/assets/images/importer/brooklyn-landing-page.jpg" />                    
                </label>
                <h3 class="xml-name">Brooklyn Landing Page</h3>
                <div class="xml-actions">
...
if ( !function_exists( 'ut_demo_importer' ) ) {
	...
	function ut_demo_importer() {
		...
		$ut_recognized_file_names = apply_filters( 'ut_recognized_file_names', array( 
		  'demo_one', 'demo_two', 'demo_three', 'demo_four', 'demo_five', 'demo_six' , 'demo_seven' , 'landing_page'
		));
			...
			if ( class_exists( 'WP_Importer' ) && class_exists( 'UT_WP_Import' ) ) {
				...
				*/
				$logo_to_demo = array(
					...
					'landing_page' => 'brooklyn-logo-dark.png',
				);
				...
				*/
				$showcase_to_demo = array(
					...
					'landing_page' => array('Grid Gallery')
				);
