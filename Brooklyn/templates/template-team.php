	...
	<?php endif; ?>
        ...
        <div class="member-wrap">
            ...
            */		
            ...
            <?php $member_ID = 1; foreach ( $team as $key => $member ) : $clear = ''; ?>
                ...
                <div class="member-box ut-member-style-3 <?php echo $ut_member_box_size; ?> <?php echo $grid[$ut_member_in_row]['class']; ?>">            
                    ...
                    <div class="mp-holder">
                        ...
                        <?php if(!empty( $member['ut_member_pic'] )) : ?>
                            ...
                            <figure class="member-photo-style-3 show_inline">
                                
                                <?php if( $avatar_style == 'ut-circle' ) {
                                    
                                    $member['ut_member_pic'] = ut_resize( $member['ut_member_pic'] , '75' , '75', true , true , true );						
                                ...
                                <img class="utlazy ut-circle floatLeft" src="<?php echo THEME_WEB_ROOT; ?>/images/placeholder/team-member.png" alt="<?php echo $member['ut_member_name']; ?>" data-original="<?php echo $member['ut_member_pic']; ?>">
                                
                             </figure>
                             
                                <div class="member-description-style-3 grid-75">
                                    <h3 class="ut-member-name"><?php echo $member['ut_member_name']; ?></h3>
                                    <span class="ut-member-title"><?php echo ut_translate_meta( $member['ut_member_title'] ); ?></span>
                                    <?php echo apply_filters( 'the_content' , $member['ut_member_description'] ); ?>
